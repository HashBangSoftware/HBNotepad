...
public class Notepadv3 extends TabActivity
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
		...
		spec.setIndicator("Notes", res.getDrawable(android.R.drawable.ic_menu_upload));
		getTabHost().addTab(spec);

		spec = getTabHost().newTabSpec("tag2");	
		spec.setContent(R.id.lists);
		spec.setIndicator("Lists", res.getDrawable(android.R.drawable.ic_menu_agenda));
		getTabHost().addTab(spec);
    ...
    private void fillData() 
    {
        ...
        lists = new SimpleCursorAdapter(this, R.layout.list_display, listsCursor, listFrom, listTo);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo)
    {
        ...
        if(getTabHost().getCurrentTab() == 0) //Notes
        {
	        ...
	        menu.setHeaderTitle(getResources().getString(R.string.create_date) +" "+ mCursor.getString(mCursor.getColumnIndexOrThrow(NotesDbAdapter.KEY_CREATE_DATE)) );
